  ...
  return (
    <div className="form-section">
      ...
      <div className="form-group">
        ...
        <input type="text" name="senderReference" value={formData.senderReference} onChange={handleInputChange} required />
      ...
      <div className="form-group">
        ...
        <input type="text" name="functionOfMessage" value={formData.functionOfMessage} onChange={handleInputChange} required />
      ...
      <div className="form-group">
        ...
        <select name="prepDateTimeOption" value={formData.prepDateTimeOption} onChange={handleInputChange}>
        ...
        <input type="text" name="prepDateTimeValue" value={formData.prepDateTimeValue} onChange={handleInputChange} placeholder="Enter date/time" />
      ...
      <div className="form-group">
        ...
        <select name="numberCountOption" value={formData.numberCountOption} onChange={handleInputChange}>
          <option value="">Select</option>
        ...
        {formData.numberCountOption && (
          <>
            <select name="numberCountQualifier" value={formData.numberCountQualifier} onChange={handleInputChange}>
            ...
            <input type="text" name="numberCountValue" value={formData.numberCountValue} onChange={handleInputChange} placeholder={formData.numberCountOption === 'B' ? 'Enter 3 digits' : 'Enter 6 digits'} />
